...
import domain.TicketByMinutesAscComparator;
...
//    }
    ...
    public void ShouldSortByCost(){
        Ticket ticket1=new Ticket(1,100500,"DME","LED",50);
        manager.add(ticket1);
        Ticket ticket2=new Ticket(2,100500,"DME","LED",95);
        manager.add(ticket2);
        Ticket ticket3=new Ticket(3,99999,"DME","LED",80);
        manager.add(ticket3);
        Ticket [] tickets=manager.findAll("DME","LED",new TicketByMinutesAscComparator());
